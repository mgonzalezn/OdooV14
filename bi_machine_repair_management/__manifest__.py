...

{
    ...
    'version': '14.0.0.2',
    'category': 'Industries',
    'summary': 'machine repair workshop product repair management equipment repair service Repair Machine Diagnosis  repair workorder Operation Maintenance Repair order machine Maintenance and repair computer Repair spare parts repair management material repair management',
    "description": """
BrowseInfo developed a new odoo/OpenERP module apps.
Manage machine repairing
==================================
...
You can choose one more invoicing method here:
...
Odoo auto service auto spareparts auto repair industry automotive workshop management software
...
Gerenciar a reparação de máquinas
Ele lida com o fluxo de trabalho de reparo completo:

** Reparação de Máquina ** Diagnóstico de Máquina ** Ordem de Serviço de Máquina **

Você pode escolher mais um método de faturamento aqui:

* * Após a ordem de serviço *: Uma fatura de rascunho é criada e deve ser paga após a conclusão da ordem de serviço.
     Este módulo usa para seguir a indústria.
     -Laptop Repair, manutenção de computadores, manutenção e operação, reparação de manutenção, indústria de serviços. Reparo de computador. Reparo de produto. Manutenção, reparo e manutenção de máquinas. Gerenciamento de Reparo de Produto
       ordem de reparo
       fluxo de trabalho de reparo
       gerenciamento de reparo de produtos
       ordem de reparação de máquinas
       diagnóstico repiar da máquina
       reparação de máquinas
       gerenciamento de reparo de máquina com fluxo dinâmico
       ordem de reparação para a máquina
       recibo de reparo de máquina
       Manutenção e gerenciamento de reparos para máquinas
       manutenção e reparo da máquina
إدارة إصلاح الجهاز

يتعامل مع سير العمل إصلاح كاملة:

** إصلاح الجهاز ** آلة التشخيص ** ترتيب عمل الآلة **

يمكنك اختيار طريقة أخرى لإعداد الفواتير هنا:

* * بعد انتهاء العمل *: يتم إنشاء فاتورة المسودة ويجب دفعها بعد الانتهاء من العمل.
     هذه الوحدة تستخدم للصناعة التالية.
     إصلاح -Laptop ، صيانة الكمبيوتر ، الصيانة والتشغيل ، صيانة إصلاح ، خدمة الصناعة. إصلاح الكمبيوتر. صيانة الآلات ، إصلاح وصيانة. إدارة إصلاح المنتج
       أجل إصلاح
       إصلاح سير العمل
       إدارة إصلاح المنتج
       ترتيب إصلاح الجهاز
       تشخيص الجهاز repiar
       ترتيب عمل الجهاز
       إدارة إصلاح الجهاز مع تدفق ديناميكي
       أمر إصلاح للجهاز
       إيصال إصلاح الجهاز
       إدارة الصيانة والإصلاح للآلة

Administrar la reparación de la máquina

Maneja el flujo de trabajo de reparación completo:

** Reparación de la máquina ** Diagnóstico de la máquina ** Orden de trabajo de la máquina **

Puede elegir otro método de facturación aquí:

* * Después de Work Order *: se crea una factura borrador y debe pagarse después de la finalización del pedido.
     Este módulo se usa para la siguiente industria.
     -Laptop Reparación, Servicio de Computadora, Mantenimiento y Operación, Reparación de Mantenimiento, Industria de Servicios. Reparación de computadoras. Reparación de productos. Mantenimiento, reparación y mantenimiento de la máquina. Gestión de reparación de productos
       orden de reparación
       flujo de trabajo de reparación
       gestión de reparación de productos
       orden de reparación de la máquina
       diagnóstico de máquina repiar
       workorder de reparación de la máquina
       gestión de reparación de máquinas con flujo dinámico
       orden de reparación para la máquina
       recibo de reparación
       Gestión de mantenimiento y reparación para máquina
       Mantenimiento y reparación de máquinas
Gérer la réparation de la machine

Il gère le flux de travail de réparation complète:

** Réparation de machine ** Diagnostic de machine ** Commande de machine **

Vous pouvez choisir une autre méthode de facturation ici:

* * Après Workorder *: Une facture préliminaire est créée et doit être payée après la fin du travail.
     Ce module est utilisé pour suivre l'industrie.
     -Réparation d'ordinateur, entretien informatique, entretien et opération, réparation d'entretien, industrie de service. Réparation d'ordinateurs. Réparation de produits. Maintenance, réparation et maintenance de la machine. Gestion de la réparation de produits
       ordre de réparation
       réparer le flux de travail
       gestion de réparation de produit
       ordre de réparation de machine
       Repiar machine Diagnostic
       travail de réparation de machine
       gestion de la réparation de machine avec flux dynamique
       ordre de réparation pour la machine
       reçu de réparation de machine
       Gestion de maintenance et de réparation pour machine
    ...
    'depends': ['base','sale_management','stock','project','account','website','website_sale','attachment_indexation','hr_timesheet'],
    'data': [
    ...
    'live_test_url':'https://youtu.be/b2Ti_kGLVrA',
}
